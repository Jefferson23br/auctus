        ...
        <div class="container">
            <div class="services-grid">
                <div class="service-card">
                    ...
                    <p>Sites institucionais modernos, responsivos, com foco em autoridade, confiança e geração de oportunidades.</p>
                </div>
                <div class="service-card">
                    <h3>E-commerce & Lojas Virtuais</h3>
                    <p>Estrutura completa para vender online com boa experiência de compra, integrações e performance.</p>
                </div>
                <div class="service-card">
